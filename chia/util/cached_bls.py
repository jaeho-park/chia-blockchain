...
def aggregate_verify(pks: List[G1Element], msgs: List[bytes], sig: G2Element, force_cache: bool = False):
    pairings: List[GTElement] = get_pairings(LOCAL_CACHE, pks, msgs, force_cache)
    if len(pairings) == 0:
